...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if ([@"GeofencingPlugin.initializeService" isEqualToString:call.method]) {
        ...
        result(@(YES));
    } else if ([@"GeofencingPlugin.determineGeofenceState" isEqualToString:call.method]) {
        [self determineGeofenceState:arguments];
        result(@(YES));
...
- (void)determineGeofenceState:(NSArray *)arguments {
